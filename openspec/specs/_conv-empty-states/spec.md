...
#### Scenario: Insufficient data for analytics

- **WHEN** a visualization requires a minimum data threshold (e.g. 2+ days for charts)
...
#### Scenario: Weight not tracked today
