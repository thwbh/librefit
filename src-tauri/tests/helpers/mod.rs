...
pub fn create_test_intake_target(
    ...
    intake::create_intake_target(&mut conn, &new_target)
        .expect("Failed to create intake target")
}
...
pub fn create_test_intake_entry(
    ...
    intake::create_intake_entry(&mut conn, &new_entry)
        .expect("Failed to create intake entry")
}
