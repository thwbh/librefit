		...
		<div class="activity-level-container flex gap-4">
			...
			<div class="card variant-glass-secondary p-4 text-left space-y-2 flex-auto w-64">
				...
				{:else if wizardInput.activityLevel === 1.75}
					...
					<p>
						Fitness is your top priority in life. You dedicate large parts of your week to train
						your body, maybe even regularly visit sportive events. You work out almost every day and
