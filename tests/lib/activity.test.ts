...
describe('activity utilities', () => {
	describe('activityLevels', () => {
		...
		it('should have appropriate badge colors', () => {
			expect(activityLevels[0].badge.color).toBe('info');
			expect(activityLevels[1].badge.color).toBe('info');
			expect(activityLevels[2].badge.color).toBe('info');
			expect(activityLevels[3].badge.color).toBe('warning');
			expect(activityLevels[4].badge.color).toBe('error');
		});
	});
